 ...
 * @author pcervera
 */
public class mVoteRun extends mMessage{
	 ...
	 * @param type
	 */
	public mVoteRun(AgtVote.voteType type){
		this.type = type;
	}
	 ...
	 * @return mRunVote
	 */
	public static mVoteRun parseJson(String jsonString){
		return (mVoteRun)mMessage.parseJson(jsonString, mVoteRun.class);
	}
