...
public class mResultVote extends mMessage{
	 ...
	 * @return mResultVote
	 */
	public static mResultVote parseJson(String jsonString){
		return (mResultVote)mMessage.parseJson(jsonString, mResultVote.class);
	}
